...
public class HomeController implements Initializable {
    ...
    public void getSettingForm(ActionEvent event) {
        createFormSetting();
        closeHomeOnAction();
    }
    ...
    public void updatePageHome() {
        Alert alertUpdate = new Alert(Alert.AlertType.INFORMATION);
        alertUpdate.setHeaderText("Notification For Update Module!!!");
        alertUpdate.setContentText("---------> Function Coming Soon^^ !!! <----------");
