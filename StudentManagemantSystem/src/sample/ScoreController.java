...
public class ScoreController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        File fileClassroom = new File("Images/update.png");
    ...
    public boolean fillComboboxClassTest() {
        boolean test = false;
        try {
            connection = databaseConnection.getConnection();
            query = "SELECT classname FROM student_db.class;";
    ...
    public boolean fillComboboxExamTest() {
        boolean test = false;
        try {
            connection = databaseConnection.getConnection();
            query = "SELECT exam_type.name_exam FROM exam_type;";
    ...
    public boolean fillComboboxCourseTest() {
        boolean test = false;
        try {
            connection = databaseConnection.getConnection();
            query = "SELECT course.coursename FROM course;";
    ...
    public boolean refreshClassroomTableViewTest(String classroom, String examType, String course) {
        boolean test = false;
        ...
        try {
            ...
            query = "SELECT student_db.student.student_id, student_db.class.classname, student_db.student.lastname, " +
                    ...
                    "LEFT JOIN student_db.exam_type ON exam_result.exam_type_id = exam_type.exam_type_id\n" +
                    "LEFT JOIN student_db.teacher ON class.teacher_id = teacher.teacher_id\n" +
                    "WHERE class.classname = \"" + classroom + "\"\n" +
                    "AND exam_type.name_exam = \"" + examType + "\"\n" +
...
//                classroomTableView.setItems(StudentList);
    ...
    public boolean updateScoreTest(String score, String studentId, String courseId, String examType) {
        boolean test = false;
        try {
...
//            student = classroomTableView.getSelectionModel().getSelectedItem();
            ...
            String query = "UPDATE student_db.exam_result SET score = \"" + score +
                    "\" WHERE student_id = \"" + studentId +
                    "\" AND course_id = \"" + courseId +
                    "\" AND exam_type_id = \"" + examType + "\";";
